...
function MyEditor(props) {
  ...
  return <Fragment>
     ...
     <TextField label="عنوان پست را وارد کنید" inputProps={{style: {
            fontFamily:"IRANSans",
            fontWeight:"400"
            }}}  
    ...
    />
     ...
     <Button variant="contained"  color="default" 
      ...
      onClick={()=>{createNewPost(title,content,picture);
        setTitle("");setContent("");setPicture(null);
        history.push("/post");}}>
        ایجاد پست</Button>


     <Button variant="contained" className={classes.backClass} onClick={()=>history.push("/post")} color="primary">بازگشت</Button>
